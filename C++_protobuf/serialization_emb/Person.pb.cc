...
const uint32_t TableStruct_Person_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Address, _impl_.house_id_),
  PROTOBUF_FIELD_OFFSET(::Address, _impl_.house_addr_),
  ~0u,  // no _has_bits_
